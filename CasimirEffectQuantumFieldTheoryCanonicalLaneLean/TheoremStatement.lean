import CasimirEffectQuantumFieldTheoryCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "Casimir pressure formula closed via analytic continuation and zeta regularization",
  certificateLane := baselineCertificateLane,
  carriedRemainder := "renormalization and temperature dependence carried as remainder"
}
